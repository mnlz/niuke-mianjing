...
cookies = {
    ...
    "Hm_lvt_a808a1326b6c06c437de769d1b85b870": "1743597767,1744638556",
    "HMACCOUNT": "8561B7C55E3D43EB",
    "acw_tc": "0a0383a817446385557584293e79c14100ea60ba12e943d0f9c806a6e816f6",
    "t": "11388C7D922AD20F05C9626360BFE89A",
    "c196c3667d214851b11233f5c17f99d5_gr_last_sent_sid_with_cs1": "d22440d3-ccfd-41ea-b1f0-ae9d9f18a52b",
    "c196c3667d214851b11233f5c17f99d5_gr_last_sent_cs1": "200533545",
    "c196c3667d214851b11233f5c17f99d5_gr_session_id": "d22440d3-ccfd-41ea-b1f0-ae9d9f18a52b",
    "c196c3667d214851b11233f5c17f99d5_gr_session_id_d22440d3-ccfd-41ea-b1f0-ae9d9f18a52b": "true",
    "c196c3667d214851b11233f5c17f99d5_gr_cs1": "200533545",
    "Hm_lpvt_a808a1326b6c06c437de769d1b85b870": "1744639409"
}
...
def get_total_pages(db_connection):
    ...
    try:
        # 构建查询语句
        query = "SELECT totalPage,total FROM `update` where post = '测开' ORDER BY `time` DESC LIMIT 1"
        # 执行查询
...
def save_page_data(db_connection, page_to_save):
    ...
    values = (now, page_to_save['totalPage'], page_to_save['total'], "测开")
    cursor.execute(sql, values)
    cursor.close()
    db_connection.commit()
...
if __name__ == '__main__':
    ...
    old_totalPage = page_sql_data['totalPage']
    old_total = page_sql_data['total']
    new_totalPage = page_online_data['totalPage']
